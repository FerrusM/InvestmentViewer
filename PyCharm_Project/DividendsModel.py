    ...
    def __init__(self):
        ...
        self.columns: tuple[Column, ...] = (
            Column(header='Величина',
                   ...
                   display_function=lambda dividend: MyMoneyValue.__str__(dividend.dividend_net, 2)),
            ...
            Column(header='Цена закрытия',
                   ...
                   display_function=lambda dividend: MyMoneyValue.__str__(dividend.close_price, 2)),
            Column(header='Доходность',
                   header_tooltip='Величина доходности.',
                   data_function=lambda dividend: dividend.yield_value,
                   display_function=lambda dividend: MyQuotation.__str__(dividend.yield_value, 2)),
